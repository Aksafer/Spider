...
OWNER_ID = int(getenv("OWNER_ID", 6092147148))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/iox7ssz/d3keoeke",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/YU_CQ")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/YR_HC")
OWNER_CHANNEL = getenv("OWNER_CHANNEL", "https://t.me/YU_CQ")
GROUP_BOT = int(getenv("GROUP_BOT", "-1002088468149"))
# Set this to True if you want the assistant to automatically leave chats after an interval
AUTO_LEAVING_ASSISTANT = bool(getenv("AUTO_LEAVING_ASSISTANT", False))


# Get this credentials from https://developer.spotify.com/dashboard
SPOTIFY_CLIENT_ID = getenv("SPOTIFY_CLIENT_ID", "3497383a173bc579a19ae3ca2f8c6114")
SPOTIFY_CLIENT_SECRET = getenv("SPOTIFY_CLIENT_SECRET", "3497383a173bc579a19ae3ca2f8c6114")
